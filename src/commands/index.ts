...
import { delete_after, displayConfig } from "./admin/timer";
...
export const commandsList = [diceRoll, newScene, help, generateTemplate, registerTemplate, rollForUser, logs, dmgRoll, displayUser, graph, changeThread, deleteChar, autoRole, mjRoll, disableThread, delete_after, displayConfig
];
